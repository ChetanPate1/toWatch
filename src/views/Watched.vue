...
<template lang="html">
  <div>
    ...
    <uiv-modal v-model="tagsModal.show" title="Tags" ref="tagsModal" :footer="false" size="sm">
      <div class="row">
        <div class="col-md-12">
          <ul class="list-group">
    ...
    <pager v-if="watchedShows.length > 15" :current-page="currentPage" :total-pages="totalPages">
    </pager>

    <div class="container fade-in">
      <div class="row margin-bottom-20">
        <div class="col-sm-5 col-md-4">
          <switch-group dark v-model="filter.sort" :options="showTypeList" @input="onChangeTab">
          </switch-group>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4" v-for="item in watchedShows" :key="item._id">
          <watched-show-card :data="item" @onDelete="(id) => {
      ...
      <no-content message="You haven't watched any shows yet!"
        v-if="!requesting && watchedShows.length == 0"></no-content>
    </div>
  </div>
</template>
