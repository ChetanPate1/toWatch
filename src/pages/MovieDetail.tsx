...
const MovieDetail = (props: Props) => {
   ...
   return (
      <div className="flex">
         <div className="flex justify-center items-center relative h-screen w-1/2 overflow-hidden" style={{ backgroundImage: `url(${data.posterXL})`, backgroundPosition: '50% 50%', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
            <img
               src={data.posterXL}
               alt={data.title}
