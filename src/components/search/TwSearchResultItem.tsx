...
const TwSearchResultItem = (props: Props) => {
   ...
   return (
      <div className="p-5 border-b-2 border-gray-100 dark:border-gray-800">
         <div className="flex gap-5 text-sm">
            ...
            <div>
               <div className="flex flex-row flex-1 justify-between">
                  <p className="text-slate-800 dark:text-slate-50 font-bold mb-2">{props.name}
                     <span className="text-slate-500 dark:text-slate-200 text-xs"> {extractYear(props.released || '')}</span>
                  </p>
