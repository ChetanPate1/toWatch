         ...
         <div className="flex gap-5 text-sm">
            ...
            <div>
               <div className="flex flex-row flex-1 justify-between">
                  <p className="text-slate-800 font-bold mb-2">{props.name}
               ...
               <div className="relative mb-4">
                  ...
                  <div className="absolute bottom-0 left-0 w-full h-6 bg-gradient-to-t from-white pointer-events-none"></div>
               </div>
            </div>
         </div>
      </div>
